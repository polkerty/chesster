...
<body>
  ...
  <div class="card">
    ...
    <div class="legend">
      <span class="pill">Eval is filled: white above 0, black below 0</span>
      <span class="pill">Perplexity signed by side-to-move (W+, B-)</span>
      <span class="pill">Forced-distance signed by side-to-move (W+, B-)</span>
      <span class="pill">Main axis: [-6, 6]</span>
      <span class="pill">Time: White above 0; Black mirrored below 0</span>
    </div>
...
{data_json}
  ...
  <script>
    ...
    function main() {{
      ...
      const perp = s.perplexity_signed || [];
      const forced = s.forced_dist_signed || [];
      ...
      new Chart(ctx, {{
        ...
        data: {{
          ...
          datasets: [
            ...
            {{
              label: "Perplexity (signed by side-to-move)",
              data: perp,
              yAxisID: "yMain",
              tension: 0.2,
              pointRadius: 0,
            ...
            {{
              label: "Moves until forced (signed by side-to-move)",
              data: forced,
              yAxisID: "yMain",
              tension: 0.2,
              pointRadius: 0,
